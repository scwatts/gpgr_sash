...
### __Breakend Annotations__ {.tabset .tabset-fade #breakends}
...
### __CNV annotations__ {.tabset .tabset-fade}
...
```{r oncoviral_summary}
vb_summary <- gpgr::virusbreakend_summary_read(vb_summary_fp)
...
vb_integrations <- gpgr::virusbreakend_vcf_read(vb_integrations_fp)
