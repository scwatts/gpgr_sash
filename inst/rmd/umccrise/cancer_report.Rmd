...
purple_plot_somaticrainfall <- file.path(img_dir, paste0(params$tumor_name, ".somatic.rainfall.png"))
...
knitr::include_graphics(file.path(img_dir, paste0(params$tumor_name, ".circos_baf.png")))
```
...
### __Breakend Annotations__ {.tabset .tabset-fade #breakend-annotations}
...
### __CNV annotations__ {.tabset .tabset-fade #cnv-annotations}
...
cnv_main_manygenesdt <- cnv_main_manygenes %>%
  ...
  DT::formatCurrency(~ Start + End + ngen, currency = "", interval = 3, mark = ",", digits = 0)
